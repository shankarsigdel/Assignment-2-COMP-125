...
(function () {
    function highlightActiveLink(id) {
        ...
        for (let _i = 0, navAnchors_1 = navAnchors; _i < navAnchors_1.length; _i++) {
            let anchor = navAnchors_1[_i];
            anchor.className = "nav-link";
        }
        for (let _a = 0, navAnchors_2 = navAnchors; _a < navAnchors_2.length; _a++) {
            let anchor = navAnchors_2[_a];
    ...
    function validateForm() {
        ...
        contactNumber.addEventListener("blur", function (event) {
        ...
        shortMessage.addEventListener("blur", function (event) {
    ...
    function InitializeSite() {
        ...
        XHR.addEventListener("readystatechange", function () {
            if ((XHR.readyState === 4) && (XHR.status === 200)) {
                ...
                for (let _i = 0, navLinks_1 = navLinks; _i < navLinks_1.length; _i++) {
                    let link = navLinks_1[_i];
                    _loop_1(link);
                }
            }
        });
